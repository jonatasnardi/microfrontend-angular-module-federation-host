...
export class AppComponent implements OnInit {
    ...
    mfeConfiguration$: Observable<FederationPlugin>;
    mfeExtendedConfiguration$: Observable<FederationPlugin>;
    mfeExtended12Configuration$: Observable<FederationPlugin>;
    ...
    ngOnInit(): void {
        ...
        this.mfeConfiguration$ = this.federationPluginService.getRemoteComponentConfiguration('mfe');
        this.mfeExtendedConfiguration$ = this.federationPluginService.getRemoteComponentConfiguration('mfeAngular12');
        this.mfeExtended12Configuration$ = this.federationPluginService.getRemoteComponentConfiguration('mfeAngular12WithProvidersExtended');
